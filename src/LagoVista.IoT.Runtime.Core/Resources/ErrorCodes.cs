...
namespace LagoVista.IoT.Runtime.Core.Resources
{
    ...
    public static class ErrorCodes
    {
        ...
        public static class Messaging
        {
            ...
            public static ErrorCode ValueIntIsNotInt { get { return new ErrorCode() { Code = "MGV1008", Message = "Value provided on Integer can not be parsed to an integer value." }; } }
            public static ErrorCode ValueDecimalINotDecimal { get { return new ErrorCode() { Code = "MGV1009", Message = "Value provided on Decimal can not be parsed to a Decimal value." }; } }
            public static ErrorCode InvalidGeoLocationFormation { get { return new ErrorCode() { Code = "MGV1010", Message = "Value provided for Geolocation is invalid, should be (-)dd.dddddd,(-)ddd.dddddd." }; } }
            ...
            public static ErrorCode InvalidDateTime { get { return new ErrorCode() { Code = "MGV1011", Message = "Invalid value stored for DateTime, format should be YYYY-MM-DDZHH:MM:SS.sssZ." }; } }
        }
